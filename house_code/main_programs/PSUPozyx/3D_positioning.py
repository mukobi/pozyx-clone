...
class ReadyToLocalize(object):
    ...
    def __init__(self, my_pozyx, my_osc_udp_client, my_anchors, my_algorithm=POZYX_POS_ALG_UWB_ONLY,
    ...
    def print_publish_error_code(self, operation):
        ...
        if network_id is None:
            ...
            return
        error_status = self.pozyx.getErrorCode(error_code, self.remote_id)
        if error_status == POZYX_SUCCESS:
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # the loop method of r prints data to the console and returns what is printed
            ...
            if to_use_file:             # writes the data returned from the loop method to the file
                if use_velocity:
                    ...
                    FileWriting.write_position_data_to_file(
                        index, elapsed, timeDifference, logfile, one_cycle_position)
