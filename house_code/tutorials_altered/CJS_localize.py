...
if __name__ == "__main__":
    ...
    anchors = [DeviceCoordinates(0x615a, 1, Coordinates(3.069, 0, 1.721)),
               DeviceCoordinates(0x607c, 1, Coordinates(0, 0, 1.362)),
               DeviceCoordinates(0x6863, 1, Coordinates(2.688, 2.457, 0.404)),
               DeviceCoordinates(0x6134, 1, Coordinates(0, 2.457, 1.123 ))]
