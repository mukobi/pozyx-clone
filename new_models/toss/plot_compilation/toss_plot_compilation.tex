...
\end{multicols}
    ...
    \includegraphics[scale=0.6]{/Users/CoraJune/Documents/GitHub/Pozyx/new_models/toss/figures/position_model/rocket.png}
...
\end{multicols}
    ...
    \includegraphics[scale=0.6]{/Users/CoraJune/Documents/GitHub/Pozyx/new_models/toss/figures/velocity_model/rocket.png} 
\end{figure}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5%
\markright{toss}
...
\end{multicols}
    ...
    \includegraphics[scale=0.6]{/Users/CoraJune/Documents/GitHub/Pozyx/new_models/toss/figures/acceleration_model/rocket.png}
\end{figure}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\markright{toss}
...
\end{multicols}
    ...
    \includegraphics[scale=0.6]{/Users/CoraJune/Documents/GitHub/Pozyx/new_models/toss/figures/dragForce_model/rocket.png}
\end{figure}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55%
\markright{toss}
