...
vi = 18.371                 # initial velocity to try (m/s)
...
c_vect = [0,1.0,1.1,1.2]    # drag coefficients to try
plt.figure()
...
for c in range(4) :
    ...
    plt.plot(xx7,dragForce)
plt.title("Modeled Drag Force Graphs")
plt.ylabel("Drag Force (N)")
plt.xlabel("Time (s)")
plt.savefig("modelDrag_rocket.pdf", bbox_inches='tight')
plt.show()
