...
df2 = df.ix[159:192].dropna() #index range pertaining to data of interest
...
popt, pcov = curve_fit(func3, x2, d2, bounds=([-10,0], [1,1.5]))
print(popt)
...
plt.legend()
plt.savefig("fitting_yellow_toss.pdf", bbox_inches='tight')
plt.show()
