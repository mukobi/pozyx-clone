...
plt.legend()
plt.tight_layout()
plt.savefig("euler_orange_freefall.pdf", bbox_inches='tight')
############################ plot gravity ##########################
plt.figure()
plt.subplot(1,1,1)
plt.title('Gravity')
...
plt.legend()
plt.tight_layout()
plt.savefig("gravity_orange_freefall.pdf", bbox_inches='tight')
...
plt.legend()
plt.tight_layout()
plt.savefig("linearA_orange_freefall.pdf", bbox_inches='tight')
######################## plot acceleration ########################
plt.figure()
plt.subplot(1,1,1)
...
plt.legend()
plt.tight_layout()
plt.savefig("acc_orange_freefall.pdf", bbox_inches='tight')
plt.show()
