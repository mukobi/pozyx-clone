...
df2 = df.ix[382:415].dropna() #index range pertaining to data of interest
# entire data set
x=df['time'].values
...
plt.legend()
plt.tight_layout()
plt.savefig("euler_blue_toss.pdf", bbox_inches='tight')
############################ plot gravity ##########################
plt.figure()
plt.subplot(1,1,1)
plt.title('Gravity')
...
plt.legend()
plt.tight_layout()
plt.savefig("gravity_blue_toss.pdf", bbox_inches='tight')
...
plt.legend()
plt.tight_layout()
plt.savefig("linA_blue_toss.pdf", bbox_inches='tight')
###################### plot acceleration ##########################
plt.figure()
plt.subplot(1,1,1)
...
plt.legend()
plt.tight_layout()
plt.savefig("acc_blue_toss.pdf", bbox_inches='tight')
plt.show()
