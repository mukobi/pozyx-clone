...
df2 = df.ix[383:415].dropna() #index range pertaining to data of interest
...
plt.tight_layout()
plt.savefig("rawpos_blue_toss.pdf", bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("velocity_blue_toss.pdf", bbox_inches='tight')
plt.show()
