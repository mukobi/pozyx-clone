...
vi = 18.372             # initial velocity to try
...
for c in range(6) :
    ...
    plt.plot(xx7,x_mod,label='$C_d={}$'.format(c_vect[c]))
    plt.legend()
    #plt.title("rocker Position (V$_i$=18.372")
    plt.ylabel("Position (m)")
    plt.xlabel("Time (s)")
    plt.title("Rocket Position (V$_i$=18.372)")
