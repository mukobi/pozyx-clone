...
plt.legend()
plt.tight_layout()
plt.savefig("euler_rocket.pdf", bbox_inches='tight')
...
plt.legend()
plt.tight_layout()
plt.savefig("gravity_rocket.pdf", bbox_inches='tight')
...
plt.legend()
plt.tight_layout()
plt.savefig("linA_rocket.pdf", bbox_inches='tight')
######################### plot acceleration ###############################
plt.figure()
plt.subplot(1,1,1)
...
plt.legend()
plt.tight_layout()
plt.savefig("acc_rocket.pdf", bbox_inches='tight')
plt.show()
