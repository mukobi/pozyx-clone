...
df2 = df.ix[43:72].dropna() #index range pertaining to data of interest
...
plt.tight_layout()
plt.savefig("rawRange_yellow.pdf", bbox_inches='tight')
...
plt.tight_layout()
plt.savefig("velocity_yellow.pdf", bbox_inches='tight')
plt.show()
