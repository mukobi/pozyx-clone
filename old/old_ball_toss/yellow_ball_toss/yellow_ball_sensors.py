...
plt.legend()
plt.tight_layout()
plt.savefig("euler_yellow.pdf", bbox_inches='tight')
############################ plot gravity ##########################
plt.figure()
plt.subplot(1,1,1)
plt.title('Gravity')
...
plt.legend()
plt.tight_layout()
plt.savefig("gravity_yellow.pdf", bbox_inches='tight')
...
plt.legend()
plt.tight_layout()
plt.savefig("linA_yellow.pdf", bbox_inches='tight')
###################### plot acceleration ##########################
plt.figure()
plt.subplot(1,1,1)
...
plt.legend()
plt.tight_layout()
plt.savefig("acc_yellow.pdf", bbox_inches='tight')
plt.show()
